export const titles = {
  ...
  email: "Email",
  motivation:
    "What is your motivation behind writing for Hayden's Journal? Tell us about your life experiences and how your connection to the Hayden's Hub mission.",
  ideaDescription:
  ...
  about: "For publishing purposes, please give a brief description of yourself. (If not, your author description will default to \"No description.\"",
  ...
  abstract: "Provide an abstract (longer, one paragraph) for your article. You can copy-and-paste it from your article, if you have one.",
  shortblurb:
...
export const categories = [
  { value: "academic", label: "Academic Article" },
  { value: "youth", label: "Youth Voices" },
  { value: "creative", label: "Creative" },
  { value: "advocacy", label: "Advocacy" },
  { value: "community", label: "Community Spotlight" },
];

export const submissionCats = [
  { value: "pitch", label: "I would like to submit a pitch for an idea" },
  { value: "draft", label: "I would like to submit my completed draft" },
];
